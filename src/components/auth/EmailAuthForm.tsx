  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (isLogin) {
        ...
        // Confirm emailがオンの場合、sessionはnullになります
        if (data.session) {
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="••••••••"
              className="w-full pl-10 pr-12 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all bg-gray-50 focus:bg-white"
              disabled={isLoading}
            />
            <button
              type="button"
